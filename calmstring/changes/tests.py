...
class TestOnChangeMethod(TestCase):
    ...
    def test_change_done_one_property(self):
        ...
        self.content_object.first_name = 'origin'
        ...
        change_done.send(
            ...
            changes={"USER_FIRSTNAME":self.content_object.first_name}
            )
        ...
        self.assertEqual(our_change.changes,{"USER_FIRSTNAME":self.content_object.first_name})
    ...
    def test_add_few_changes(self):
        ...
        self.content_object.last_name = 'master'
        self.content_object.save()
        change_done.send(
            sender=self.__class__,
            author=self.author,
...
class TestReverted(TestCase):
    ...
    def test_revert_changes(self):
        ...
        self.assertEqual(self.content_object.last_name,'master')

        _,reverted_content_object = Change.reverted(to=change1)
        
        self.assertEqual(reverted_content_object.last_name,'')
